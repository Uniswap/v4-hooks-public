...
| Name         | Date       | Report                                                                   |
| ------------ | ---------- | ------------------------------------------------------------------------ |
| WETHHook     | 04/24/2025 | [OpenZeppelin](https://github.com/Uniswap/v4-hooks-public/blob/main/docs/audits/Uniswap_V4_WETH_and_WstETH_Hooks_Audit.pdf) |
| WstETHHook   | 04/24/2025 | [OpenZeppelin](https://github.com/Uniswap/v4-hooks-public/blob/main/docs/audits/Uniswap_V4_WETH_and_WstETH_Hooks_Audit.pdf) |
