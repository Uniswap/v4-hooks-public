---
title: "IFluidDexLite"
description: "Interface for the Fluid DEX Lite pool"
---

# IFluidDexLite

[Git Source](https://github.com/Uniswap/v4-hooks-internal/blob/d2a38d0852d124855be2202d8846e0259e3cfe28/src/aggregator-hooks/implementations/FluidDexLite/interfaces/IFluidDexLite.sol)
...
<a id="swapsingle-dexkey-bool-int256-uint256-address-bool-bytes-bytes"></a>
...
| fee | `uint256` |  |
| revenueCut | `uint256` |  |
| rebalancingStatus | `uint256` |  |
| isCenterPriceShiftActive | `bool` |  |
| centerPrice | `uint256` |  |
| centerPriceAddress | `address` |  |
| isRangePercentShiftActive | `bool` |  |
| upperRangePercent | `uint256` |  |
| lowerRangePercent | `uint256` |  |
| isThresholdPercentShiftActive | `bool` |  |
| upperShiftThresholdPercent | `uint256` |  |
| lowerShiftThresholdPercent | `uint256` |  |
| token0Decimals | `uint256` |  |
| token1Decimals | `uint256` |  |
| totalToken0AdjustedAmount | `uint256` |  |
| totalToken1AdjustedAmount | `uint256` |  |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| lastInteractionTimestamp | `uint256` |  |
| rebalancingShiftingTime | `uint256` |  |
| maxCenterPrice | `uint256` |  |
| minCenterPrice | `uint256` |  |
| shiftPercentage | `uint256` |  |
| centerPriceShiftingTime | `uint256` |  |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| oldUpperRangePercent | `uint256` |  |
| oldLowerRangePercent | `uint256` |  |
| shiftingTime | `uint256` |  |
| startTimestamp | `uint256` |  |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| oldUpperThresholdPercent | `uint256` |  |
| oldLowerThresholdPercent | `uint256` |  |
| shiftingTime | `uint256` |  |
| startTimestamp | `uint256` |  |
...
| poolPrice | `uint256` |  |
| centerPrice | `uint256` |  |
| upperRangePrice | `uint256` |  |
| lowerRangePrice | `uint256` |  |
| upperThresholdPrice | `uint256` |  |
| lowerThresholdPrice | `uint256` |  |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| token0RealReserves | `uint256` |  |
| token1RealReserves | `uint256` |  |
| token0ImaginaryReserves | `uint256` |  |
| token1ImaginaryReserves | `uint256` |  |
