...
description: "Factory for creating StableSwapAggregator hooks via CREATE2 and initializing Uniswap V4 pools"
---

# StableSwapAggregatorFactory

[Git Source](https://github.com/Uniswap/v4-hooks-internal/blob/d2a38d0852d124855be2202d8846e0259e3cfe28/src/aggregator-hooks/implementations/StableSwap/StableSwapAggregatorFactory.sol)
...
<a id="constructor-ipoolmanager-imetaregistry"></a>
...
<a id="createpool-bytes32-icurvestableswap-currency-uint24-int24-uint160"></a>
...
<a id="computeaddress-bytes32-icurvestableswap"></a>
