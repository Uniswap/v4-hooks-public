...
description: "Interface for Tempo's enshrined stablecoin DEX"
---

# ITempoExchange

[Git Source](https://github.com/Uniswap/v4-hooks-internal/blob/d2a38d0852d124855be2202d8846e0259e3cfe28/src/aggregator-hooks/implementations/TempoExchange/interfaces/ITempoExchange.sol)
...
<a id="swapexactamountin-address-address-uint128-uint128"></a>
...
<a id="swapexactamountout-address-address-uint128-uint128"></a>
...
<a id="quoteswapexactamountin-address-address-uint128"></a>
...
<a id="quoteswapexactamountout-address-address-uint128"></a>
