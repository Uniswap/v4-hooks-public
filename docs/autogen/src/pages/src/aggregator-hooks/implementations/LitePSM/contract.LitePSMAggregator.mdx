...
description: "Singleton Uniswap V4 hook that routes gem ↔ stable swaps through a MakerDAO LitePSM"
---

# LitePSMAggregator

[Git Source](https://github.com/Uniswap/v4-hooks-internal/blob/d2a38d0852d124855be2202d8846e0259e3cfe28/src/aggregator-hooks/implementations/LitePSM/LitePSMAggregator.sol)
...
<a id="constructor-ipoolmanager-ilitepsm-address"></a>
