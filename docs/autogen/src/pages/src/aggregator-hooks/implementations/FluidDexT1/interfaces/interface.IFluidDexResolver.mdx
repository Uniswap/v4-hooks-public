...
description: "Interface for the Fluid DEX T1 resolver"
---

# IFluidDexResolver

[Git Source](https://github.com/Uniswap/v4-hooks-internal/blob/d2a38d0852d124855be2202d8846e0259e3cfe28/src/aggregator-hooks/implementations/FluidDexT1/interfaces/IFluidDexResolver.sol)
...
<a id="estimateswapin-address-bool-uint256-uint256"></a>
...
<a id="estimateswapout-address-bool-uint256-uint256"></a>
