...
description: "a minimal library for mining aggregator hook addresses"
---

# AggregatorHookMiner

[Git Source](https://github.com/Uniswap/v4-hooks-internal/blob/d2a38d0852d124855be2202d8846e0259e3cfe28/src/aggregator-hooks/utils/AggregatorHookMiner.sol)
...
<a id="find-address-uint160-uint8-bytes-bytes-uint256"></a>
