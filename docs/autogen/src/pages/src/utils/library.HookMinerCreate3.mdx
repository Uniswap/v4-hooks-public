...
description: "A minimal library for mining hook addresses using CREATE3"
---

# HookMinerCreate3

[Git Source](https://github.com/Uniswap/v4-hooks-internal/blob/d2a38d0852d124855be2202d8846e0259e3cfe28/src/utils/HookMinerCreate3.sol)
...
<a id="findwithprefix-address-uint160-bytes-bytes-string"></a>
