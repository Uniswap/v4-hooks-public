...
[Git Source](https://github.com/Uniswap/v4-hooks-internal/blob/17d7d5811380e775c83dd0663f30fb95c53d02b9/src/aggregator-hooks/implementations/FluidDexT1/interfaces/IFluidDexReservesResolver.sol)
...
|Name|Type|Description|
|----|----|-----------|
|`poolData_`|`PoolWithReserves`|The pool data including reserves|
