# MultiAssetVault
[Git Source](https://github.com/uniswap/v4-hooks-internal/blob/0a317c27dcab11b55acb839bccd006c6ffa8744c/src/alf/base/vault/MultiAssetVault.sol)
...
### SameBlockWithdraw
`_withdraw` was called in the same block as the depositor's last `_deposit`.
