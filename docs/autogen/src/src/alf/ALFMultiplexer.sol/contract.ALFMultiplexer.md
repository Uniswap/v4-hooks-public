...
## Structs
### FillCandidate
Tracks a quoter candidate during the split fill process. Built during
...
|`hookData`|`bytes`|Constructed ALFHookData for this candidate (attestation + curve update).|
