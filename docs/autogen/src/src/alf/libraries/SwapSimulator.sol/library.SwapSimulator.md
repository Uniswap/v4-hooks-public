# SwapSimulator
[Git Source](https://github.com/uniswap/v4-hooks-internal/blob/9ca86fbc7a5f56be0963bea4dd445ca15a270071/src/alf/libraries/SwapSimulator.sol)
...
`amountIn` is GROSS of the protocol fee: it mirrors `Pool.swap`'s swapper frame, which
...
|Name|Type|Description|
|----|----|-----------|
|`amountIn`|`uint256`|Total input consumed (gross of LP and protocol fees).|
