...
import {StableStableQuoterHook} from "../../src/propamm/StableStableQuoterHook.sol";
...
import {SwapSimulator} from "../../src/propamm/libraries/SwapSimulator.sol";
...
contract StableStableQuoterHookTest is Test, Deployers {
    ...
    function setUp() public {
        ...
        deployCodeTo(
            ...
            abi.encode(manager, address(index), address(attestationRegistry), uint32(100_000), owner, configManager),
            address(hook)
        );
    ...
    function test_initializePool_registersInIndex() public view {
    ...
    function _buildCurveUpdateHookData(
        ...
        hookData = abi.encode(QuoterHookData({attestationData: "", curveUpdateData: curveUpdateData}));
    }
    ...
    function test_getIndicativeQuote_withCurveUpdate_usesNewConfig() public {
        ...
        bytes memory hookData = abi.encode(QuoterHookData({attestationData: "", curveUpdateData: curveUpdateData}));
    ...
    function test_setPoolLive_updatesLivenessAndIndex() public {
        vm.prank(owner);
        hook.setPoolLive(testPoolKey, false);
