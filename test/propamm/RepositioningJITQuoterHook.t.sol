...
import {RepositioningJITQuoterHook} from "../../src/propamm/RepositioningJITQuoterHook.sol";
...
contract RepositioningJITQuoterHookTest is Test, Deployers {
    ...
    function setUp() public {
        ...
        deployCodeTo(
            ...
            abi.encode(manager, address(index), address(attestationRegistry), uint32(100_000), owner),
            address(hook)
        );
    ...
    function test_curveUpdate_expired_reverts() public {
        ...
        // Encode as QuoterHookData (attestationData, curveUpdateData)
