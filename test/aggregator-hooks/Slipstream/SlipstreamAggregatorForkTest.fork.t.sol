...
/// Pool manager / quoter: `SLIPSTREAM_POOL_MANAGER` / `SLIPSTREAM_QUOTER_V2` if set, else `POOL_MANAGER` / `QUOTER_V2`.
contract SlipstreamAggregatorForkTest is Test {
    ...
    function setUp() public {
        ...
        address poolManagerAddress = vm.envAddress("SLIPSTREAM_POOL_MANAGER");
