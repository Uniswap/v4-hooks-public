...
/// Pool manager / quoter: `UNISWAP_V3_POOL_MANAGER` / `UNISWAP_V3_QUOTER_V2` if set, else `POOL_MANAGER` / `QUOTER_V2`.
contract UniswapV3AggregatorForkTest is Test {
    ...
    function setUp() public {
        ...
        address poolManagerAddress = vm.envAddress("UNISWAP_V3_POOL_MANAGER");
