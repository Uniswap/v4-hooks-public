...
contract FeeCalculationTest is Test {
    ...
    // =============================================================================
    // INVARIANT: flexibleFee >= targetFee and flexibleFee <= ONE_E12
    ...
    // =============================================================================
    // INVARIANT: flexibleFee == targetFee when previousFee == targetFee
    // (no gap to decay means fee stays exactly at target regardless of k or blocks)
    // =============================================================================

    function test_fuzz_calculateFlexibleFee_eqTarget_whenPreviousEqTarget(
        uint256 targetFeeE12,
        uint24 k,
        uint40 blocksPassed
    ) public pure {
        ...
        uint256 flexibleFeeE12 = FeeCalculation.calculateFlexibleFee(targetFeeE12, targetFeeE12, k, logK, blocksPassed);
        assertEq(flexibleFeeE12, targetFeeE12);
    }
    ...
    function test_fuzz_adjustedFee_geq_newTarget(
        ...
        int256 oldCloseFeeE12 = FeeCalculation.calculateCloseFee(oldPriceRatioX96, optimalFeeE6);
        uint256 oldFarFeeE12 = FeeCalculation.calculateFarFee(oldPriceRatioX96, optimalFeeE6);
        ...
        int256 newCloseFeeE12 = FeeCalculation.calculateCloseFee(newPriceRatioX96, optimalFeeE6);
        uint256 newFarFeeE12 = FeeCalculation.calculateFarFee(newPriceRatioX96, optimalFeeE6);
